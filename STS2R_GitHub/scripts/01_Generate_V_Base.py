...
OUTPUT_DIR = r"outputs\Generated_ablation_data\01_Base"
N_VARIANTS = 50

def main():
    print(f"🚀 Starting 01_Generate_V_Base pipeline...")
    ...
    for input_path in tqdm(files, desc="Processing Files"):
        ...
        for i in range(1, N_VARIANTS + 1):
            try:
                ...
                aug_data = general_augment(seed_data, rng, lam)
    ...
    print(f"✅ Pipeline 01 finished. Results saved to {OUTPUT_DIR}")
